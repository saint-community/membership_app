    ...
    <View style={styles.tabContainer}>
      ...
      <Animated.View
        ...
        <Svg width="90" height="45" style={styles.svgCutout} viewBox="0 0 90 45">
          <Path d="M90 0C73 0 87.5 45 45 45C2.5 45 17.5 0 0 0H90Z" fill={COLORS.dark.background} />
        </Svg>
      </Animated.View>
    ...
    <Tabs
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <AnimatedTabIcon focused={focused}>
              <Feather name="home" color={focused ? 'white' : '#666666'} size={24} />
            </AnimatedTabIcon>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <AnimatedTabIcon focused={focused}>
              <FontAwesome5 name="pray" color={focused ? 'white' : '#666666'} size={24} />
            </AnimatedTabIcon>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <AnimatedTabIcon focused={focused}>
              <Ionicons name="book-outline" color={focused ? 'white' : '#666666'} size={24} />
            </AnimatedTabIcon>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <AnimatedTabIcon focused={focused}>
              <FontAwesome6 name="users" color={focused ? 'white' : '#666666'} size={24} />
            </AnimatedTabIcon>
          ),
        }}
      />
      <Tabs.Screen
        ...
        options={{
          tabBarIcon: ({ focused }) => (
            <AnimatedTabIcon focused={focused}>
              <MaterialIcons name="list-alt" color={focused ? 'white' : '#666666'} size={24} />
            </AnimatedTabIcon>
          ),
        }}
      />
